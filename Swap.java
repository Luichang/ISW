	...
	public void execute() {
		if (this.pokemon1.getSwapAllow() && this.pokemon2.getSwapAllow()) {
			...
			if (this.pokemon2.getSwapAllow()) {
				System.out.println("Pokemon " + this.pokemon1.getName() + " is not up for trade");
			}
			else if (this.pokemon1.getSwapAllow()) {
				System.out.println("Pokemon " + this.pokemon2.getName() + " is not up for trade");
			} 
			else {
				System.out.println("Both Pokemon " + this.pokemon1.getName() + " and " + this.pokemon2.getName() + " is not up for trade");
			}
		}
	}
}