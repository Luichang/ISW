public class PokemonTest {
    ...
    System.out.println(
        "Charmander Number: " + charmander.getNumber() + " and Squirtle Number: " + squirtle.getNumber());
    ...
    System.out.println(
        "Ah yes thank you " + red.toString() + " it was " + blue.getLastname() + ", " + blue.getFirstname());
