...
public class Movie extends AbstractModelObject implements Serializable {
    ...
    private final int BORROW = 14;
    private final int EXTEND = 7;
    ...
    private boolean istVerliehen = false;
    ...
    public Boolean getIstVerliehen() {
      return istVerliehen;
    }
    ...
    public void setReturnDate(int days) {
      if(this.returnDate == null || days == BORROW) {
        this.returnDate = new Date();
      }
      Date oldValue = this.returnDate;
      istVerliehen = true;
      this.returnDate.setDate(this.returnDate.getDate() + days);
      firePropertyChange("returnDate", oldValue, this.returnDate);
    }
    
    public void setReturnDate() {
      System.out.println("Test");
      istVerliehen = false;
      firePropertyChange("returnDate", this.returnDate, 0);
    }
